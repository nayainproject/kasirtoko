...
Route::middleware('auth')->group(function(){
    ...
    Route::resource('stok',StokController::class)->only('index','create','store','destroy','edit','update');
});
...
Route::middleware('auth')->group(function () {
    ...
    Route::resource('cart', CartController::class)->except('create','show','edit','destroy')
